...
#define _INTERVAL_DIST    75 // distance sensor interval (unit: ms)
#define _INTERVAL_SERVO   10 // servo interval (unit: ms)
#define _INTERVAL_SERIAL  350 // serial interval (unit: ms)
...
#define _DUTY_MAX 2406 // 2000
#define _DUTY_NEU 1541 // 1500
#define _DUTY_MIN 500 // 1000

#define _SERVO_ANGLE_DIFF  80  // Replace with |D - E| degree D(low) = 70, E(high) = 290
